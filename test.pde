...
void setup()
{
  ...
  hm.put(1, "data/workit.wav");
  hm.put(2, "data/doit.wav");
  hm.put(3, "data/harder.wav");
  hm.put(4, "data/stronger.wav");
  hm.put(5, "data/workit.wav");
  hm.put(6, "data/doit.wav");
  hm.put(7, "data/harder.wav");
  hm.put(8, "data/stronger.wav");
...
void draw()
{
  String[] lines = loadStrings("./pressed_keys.txt");
  if(lines.length != a) {
